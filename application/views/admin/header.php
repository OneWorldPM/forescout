...
<!--                            <li class="<?= ($uri_segment == 'user') ? 'active' : ''; ?>" >
                            ...
                            <li class="<?= ($uri_segment == 'user') ? 'active open' : ''; ?>">
                                <a href="" id="dash">
                                    <div class="item-content">
                                        <div class="item-media">
                                            <i class="fa fa-users"></i>
                                ...
                                <ul class="sub-menu <?= ($uri_segment == 'user') ? 'active' : ''; ?>" style="<?= ($uri_segment == 'user') ? 'display: block' : 'display: none'; ?>;">
                                    <li class="">
                                    ...
                                    <li class="">
                                        <a href="<?= site_url() ?>admin/user/pending_user">
                                            Pending User
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="<?= ($uri_segment == 'partner') ? 'active' : ''; ?>" >
                                <a href="<?= site_url() ?>admin/partner" id="dash">
                                    <div class="item-content">
                                        <div class="item-media">
                                            <i class="fa fa-users"></i>
                                        </div>
                            ...
                            <li class="<?= ($uri_segment == 'Support_Live_Chat') ? 'active' : ''; ?>" >
                                <a href="<?= site_url() ?>admin/Support_Live_Chat" id="dash">
                                    <div class="item-content">
                                        ...
                                        <div class="item-inner">
                                            <span class="title">Support- Live Chat</span>
                                        </div>
                                    </div>
                                </a>
                            </li>
